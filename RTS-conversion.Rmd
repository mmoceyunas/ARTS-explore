...
Margo_RTS_v1 = read_sf("Margo-RTS-v1.0/Margo-RTS-v1.shp")
...
#example subset code
example_NegativeGrid = subset(example, example$TrainClass == "Negative")
example_NotFurtherReview = subset(example, example$Notes != "Further_Review") #! = not
